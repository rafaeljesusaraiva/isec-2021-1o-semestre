...
void exemplo2() {
    std::cout << "Introduza dois numeros" << std::endl; //apresenta frase
                                    //envia para sa�da standard e muda de linha
    int v1, v2; //declara��o onde se usa
    std::cin >> v1 >> v2;      
    std::cout << "soma de " << v1 << " com " << v2 << " da " << v1 + v2 
              << std::endl;
}

//using std::cin;  //tamb�m podia ser assim
//using std::cout;
//using std::endl;
...
void exemplo4() {
    ...
    cout << "s1:" << s1 << endl;
    string s2 = s1; //s2 � uma c�pia de s1
    cout << "s2:" << s2 << endl;
    string s3 = "Bom dia"; //s3 � uma c�pia da string literal
    cout << "s3:" << s3 << endl;
...
void f1e3a() {
    cout << "nome: " << endl;
    string nome; //sequencia de carateres de tamanho vari�vel
    cin >> nome;
    cout << "idade: " << endl;
    int idade;
    cin >> idade;
